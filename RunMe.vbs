...
strMenu="Please type Enter your selection (1-6)" & VbCrLf &_
 "1 Skein (Universal\Highest Hashrate)" & VbCrLf &_
 "2 Qubit (Best for CPU and AMD cards)"  & VbCrLf &_
 "3 Groestl (Recommended for Nvidia Cards)"  & VbCrLf &_
 "4 Scrypt (Not Recommended for Profitability!)" & VbCrLf &_
 "5 Help (Opens help Website)" & VbCrLf &_
 "6 Advanced (Opens poweruser options)"
...
While R=3 do
If Hidden=1 Then
objshell.Run chr(34) & ".\Groestlhidden.vbs" & Chr(34), 0
End If
If Hidden=0 Then
