...
objshell.run "ScryptCPU32.EXE" & " " & "-a scrypt -o" & " " &  ScryptPool & " " & "-u" & " " & WalletADR & " " & "-p 912837465" & " " & "--threads" & " " & threads 
End If
If Arch="X64" Then
objShell.CurrentDirectory = ".\Scrypt"
End If 
If CPUMine=1 and Arch="X64" Then
objshell.run "ScryptCPU64.EXE" & " " & "-a scrypt -o" & " " &  ScryptPool & " " & "-u" & " " & WalletADR & " " & "-p 912837465" & " " & "--threads" & " " & threads 
End If
If OCL=0 Then
...
objshell.run "ScryptGPU.EXE" & " " & "--Intensity D -o" & " " &  ScryptPool & " " & "-u" & " " & WalletADR & " " & "-p 912837465"
End If
If OCL=1 and Cuda = 1 Then 
objShell.CurrentDirectory = ".\ScryptGPU"
 objShell.run "ScryptNVGPU.EXE" & " " & "-a scrypt -o" & " " &  ScryptPool & " " & "-u" & " " & WalletADR & " " & "-p 912837465"
End If
