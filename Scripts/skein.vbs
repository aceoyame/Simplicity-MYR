...
objshell.run "SkeinCPU32.EXE" & " " & "-a skein -o" & " " &  SkeinPool & " " & "-u" & " " & WalletADR & " " & "-p 912837465" & " " & "--threads" & " " & threads 
End If
If Arch="X64" Then
objShell.CurrentDirectory = ".\Skein"
End IF
If CPUMine=1 and Arch="X64" Then
objshell.run "SkeinCPU64.EXE" & " " & "-a skein -o" & " " &  SkeinPool & " " & "-u" & " " & WalletADR & " " & "-p 912837465" & " " & "--threads" & " " & threads 
End If
If OCL=0 Then
...
objshell.run "SkeinGPU.EXE" & " " & "-k skein --intensity D -o" & " " &  SkeinPool & " " & "-u" & " " & WalletADR & " " & "-p 912837465"
End If